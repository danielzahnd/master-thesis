...
\subsection{Results of the experiment}
 % Explain used model and considered spectral lines
...
\section{Experiment 3: Multiple maps analysis}
% Experiment 2
\subsection{Explanation of the experiment}
Text.
...
\section{Experiment 4: Multiple maps analysis using a different map for training}
% Experiment 4
\subsection{Explanation of the experiment}
Text.
...
\chapter{Discussion and interpretation}\label{chap:discussion}
\section{Experiment 1: Training on synthetic data}
Text.
