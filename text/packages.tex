...
\usepackage{tabularx} % Table-making package
...
\usepackage{xurl} % Break url's more gracefully
\usepackage{bigfoot} % Make footnotes nicer
...
%\usepackage{draftwatermark} % Add draft watermark, put % if watermark is to be removed